...
1. **Gestión centralizada ineficiente**:
    ...
    - La necesidad de mantener un único archivo maestro en el **NIC** y distribuirlo manualmente a cada administrador se volvió impráctica a medida que la red se expandía.
...
4. **Falta de robustez y flexibilidad**:
